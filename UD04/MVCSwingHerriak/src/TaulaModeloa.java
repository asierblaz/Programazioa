...
public class TaulaModeloa extends AbstractTableModel implements Serializable {
...
//
     ...
     * @see #setValueAt
     */
    public TaulaModeloa(int rowCount, int columnCount) {
     ...
     * @see #setValueAt
     */
    public TaulaModeloa(Vector<?> columnNames, int rowCount) {
     ...
     * @see #setValueAt
     */
    public TaulaModeloa(Object[] columnNames, int rowCount) {
     ...
     */
    @SuppressWarnings("rawtypes")
    public TaulaModeloa(Vector<? extends Vector> data, Vector<?> columnNames) {
     ...
     * @see #setDataVector
     */
    public TaulaModeloa(Object[][] data, Object[] columnNames) {
        setDataVector(data, columnNames);
    }
