...
public class TableModelBi extends AbstractTableModel implements Serializable {
...
//
     ...
     * @see #setValueAt
     */
    public TableModelBi(int rowCount, int columnCount) {
     ...
     * @see #setValueAt
     */
    public TableModelBi(Vector<?> columnNames, int rowCount) {
     ...
     * @see #setValueAt
     */
    public TableModelBi(Object[] columnNames, int rowCount) {
     ...
     */
    @SuppressWarnings("rawtypes")
    public TableModelBi(Vector<? extends Vector> data, Vector<?> columnNames) {
     ...
     * @see #setDataVector
     */
    public TableModelBi(Object[][] data, Object[] columnNames) {
        setDataVector(data, columnNames);
    }
