...
public class ArithmeticTest {
   ...
   public static void main(String[] args) {
      ...
      System.out.print("The sum, difference, product, quotient and remainder of ");  // Print description
       ...
       System.out.println(number1+ " and "+number2+" are "+sum+ ", "+difference+", "+product+", "+quotient+", and "+remainder);
...
//      System.out.println(remainder);
      ...
      System.out.println("The new quotient of " + number1 + " and " + number2 
            + " is " + quotient);
      int printsum= (31* number1)+ (17*number2);
      
       System.out.println("The sum of 31 times of number1 and 17 times of number2: " + printsum);
   }
